        ...
        try {
            ...
            if ( rowsAffected > 0) { // ou seja, se inseriu algo
                ...
                if (rs.next()) { // Se existe a linha
                    ...
                    department.setDepartmentID(id);  // atribuo o id gerado ao novo departamento
                }
                else {
    ...
    public Department findById(Integer id) {
        ...
        try {
            ...
            if (rs.next()) { // Se encontrei algo, então
                ...
                department.setDepartmentName(rs.getString("Name")); // Pego o nome encontrado
                department.setDepartmentID(rs.getInt("Id"));  // Pego o id encontrado
